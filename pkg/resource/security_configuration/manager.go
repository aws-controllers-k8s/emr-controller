...
// +kubebuilder:rbac:groups=emr.services.k8s.aws,resources=securityconfigurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=emr.services.k8s.aws,resources=securityconfigurations/status,verbs=get;update;patch
