...
const (
	FinalizerString = "finalizers.emr.services.k8s.aws/SecurityConfiguration"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("securityconfigurations")
	GroupKind            = metav1.GroupKind{
		Group: "emr.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.SecurityConfiguration{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.SecurityConfiguration),
	}
}
